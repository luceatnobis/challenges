#!/usr/bin/env python3
# https://www.hackthis.co.uk/levels/captcha/2
...
def main():
    ...
    chall_url = "https://www.hackthis.co.uk/levels/captcha/2"
    captcha_url = "https://www.hackthis.co.uk/levels/extras/captcha2.php"
