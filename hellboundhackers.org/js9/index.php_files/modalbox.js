...
Modalbox.Methods = {
	...
	options: {
		...
		closeValue: "Close", // Default string for close link in the header
		params: {},
	...
	_init: function(options) {
		...
		this.MBlevel = new Element("div", {id: "MB_level", style: "display:block; position: absolute; left: 14px; top: 35px"}).update("<img src='../fusion_images/levels/"+this.options.level+".gif' />");
		this.MBframe.insert({'bottom':this.MBlevel});
