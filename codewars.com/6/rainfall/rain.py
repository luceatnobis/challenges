...
def t(s, town):
    d = {x: y for x, y in [x.split(":", 1) for x in s.splitlines()]}
    return d.get(town, -1)
...
def mean(town, string):
    ...
    if s == -1:
        return s
    d = [float(x.split(" ")[1]) for x in s.split(",")]
    return (sum(d) / len(d))
...
def variance(town, string):
    ...
    if s == -1:
        return s
    m = mean(town, string)
    d = [(float(x.split(" ")[1])-m)**2 for x in s.split(",")]
    return sum(d) / len(d)
...
Lima:Jan 11.2,Feb 10.9,Mar 10.7,Apr 10.4,May 10.6,Jun 11.8,Jul 14.4,Aug 13.1,Sep 23.3,Oct 1.7,Nov 0.5,Dec 10.7"""
    ...
    print(mean("Bei", data))
    """
    print(assertFuzzyEquals(mean("London", data), 51.199999999999996))
    print(assertFuzzyEquals(mean("Beijing", data), 52.416666666666664))

    print(variance("London", data))
    print(assertFuzzyEquals(variance("London", data), 57.42833333333374))
    print(assertFuzzyEquals(variance("Beijing", data), 4808.37138888889))
